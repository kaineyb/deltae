def delta_e_2000_test_builder():
    ...
    with open("test.py", "w") as f:
        f.write("import deltae\n")
        f.write("import unittest\n")
        f.write("class TestDeltaE2000(unittest.TestCase):\n\n")
        ...
        for index, row in Rds_df.iterrows():
            ...
            f.write(
                "\t\ta1Prime, a2Prime, c1Prime, c2Prime, h1Prime, h2Prime, hBarPrime, g, t, sL, sC, sH, rT, de2000=deltae.delta_e_2000(Lab1, Lab2, test=True, formula='Rochester')\n\n"
            )

            f.writelines(
                f"\t\tself.assertEqual({key}, {value})\n"
